...
#python cuda-convnet/convnet.py -f /home/LIV/axf/shared/results/iris.printed.MobBIOfake.sq.32.3-py/${outputnet} --multiview-test=1 --test-only=1 --logreg-name=logprob --test-range=5

# Viewing learned filters in fully-connected layers
python cuda-convnet/shownet.py -f /home/LIV/axf/shared/results/iris.printed.MobBIOfake.sq.32.3-py/${outputnet} --show-filters=fc2 --channels=32

## Viewing test case predictions
#python cuda-convnet/shownet.py -f /home/LIV/axf/shared/results/iris.printed.MobBIOfake.sq.32.3-py/${outputnet} --show-preds=probs
